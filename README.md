...
1. **TBD**: Dependencies are only queried from non-sketch features in part studios. 
1. **TBD**: Only the main branch is considered. Dependencies in non-main branches are not queried. 